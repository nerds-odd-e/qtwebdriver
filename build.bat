...
rem rd /S /Q build out-rel
rem gyp --depth . -f msvs -G msvs_version=2015 -G output_dir=. -D platform=desktop -D mode=release --generator-output=out-rel/ wd.gyp
rem devenv .\out-rel\wd.sln /rebuild "Default|x64"
